...
bgtnummer = arcpy.GetParameterAsText(1) #Configure parameter: Input, String, Required
...
def writeOutput(toetspath, inputlayer):
    ...
    if templatesheet != "":
        ...
        standard_rapport = rf"G:\civ\IGA_ATG\Producten\BGT\Toetstooling\beoordelingsrapport_template\beoordelingsrapport_bgt.xlsm"
    ...
    vraag_cel_map = {
        "6.3 Zijn de verplichte RWS-objecten, volgens de 'gegevenscatalogus BGT 1.2', in de levering aanwezig?": "C91",
        "6.4 Voldoen de mutaties van de objecttypes aan de BGT-specificaties of 'gegevenscatalogus BGT 1.2'?": "C98",
        "6.5 Is bij de plaatsbepalingspunten de administratie correct ingevuld?": "C105",
        "6.6 Representeert de BGT dezelfde werkelijkheid van het areaal als het DTB?": "C112",
        "6.7 Voldoen de mutaties in de levering, ten aanzien van aangrenzende bronhouders, aan de BGT-productspecificaties?": "C119"
    }
    ...
    with arcpy.da.SearchCursor(zichtbaarlayer, [kolom1, kolom2, kolom3, kolom4, kolom5, kolom6, kolom7]) as cursor:
            for row in cursor:
                ...
                if voorkomen == "Eenmalig":
                    ...
                    voorkomentxt = f"Deze situatie komt vaker voor in het geleverde BGT-bestand.\n"
                ...
                fout_bevinding_map = {"C91":"M90","C98":"M97","C105":"M104","C112":"M111","C119":"M118"}
